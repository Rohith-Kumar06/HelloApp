...
Loop or Default Message The application should accept multiple names as command-line arguments and display a personalized greeting for each user using
an enhanced for loop. If no names are provided, it should display "Hello, World!".
Usage: java HelloApp [namel] [name2] ...
[nameN]
